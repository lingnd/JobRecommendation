...
public class ExampleBookServlet extends HttpServlet {
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        //use case for a client saving and writing information / how to write data by post
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        //Use case for a client (web pages, mobile apps) retrieving information
        //there is service making the query based on the provided parameter and gets back the result of a book
        //parameter parsing
        ...
        //we write it back to the client in response:
